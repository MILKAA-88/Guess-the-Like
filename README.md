...
* Pour participer, il faut être assigné à un groupe :
	•	Soit vous créez un groupe (et vous verrez une suite de caractères unique),
	•	Soit vous rejoignez un groupe existant via le code.
